...
class ModuleNamespaceTest extends BaseModuleTestCase
{
     ...
     * @return array
     */
    public function providerActivateTwoModulesAndThenDeactivateOne()
    {
     ...
     * @group module
     *
     * @dataProvider providerActivateTwoModulesAndThenDeactivateOne()
     *
     ...
     */
    public function testActivateTwoModulesAndThenDeactivateOne(
        $installModules,
    ...
    )
    {
        ...
        $classAlias = 'oxprice';
        $this->assertEquals($fullClassChainToAssert, $moduleChainsGenerator->getFullChain($class, $classAlias));
        $this->assertEquals($fullClassChainToAssert, $moduleChainsGenerator->filterInactiveExtensions($fullClassChainToAssert));
        ...
        $this->assertEquals($fullClassChainToAssert, $moduleChainsGenerator->getFullChain($class, $classAlias));
        $this->assertEquals($classChainWithActiveModulesToAssert, $moduleChainsGenerator->filterInactiveExtensions($fullClassChainToAssert));
    }
