...
class ModuleMetadataValidatorTest extends \OxidTestCase
{
    ...
    {
        $moduleMock = $this->getMock(\OxidEsales\Eshop\Core\Module\Module::class, array('getId', 'getExtensionsFromMetadata'));
        $moduleMock->expects($this->once())->method('getExtensionsFromMetadata')->will($this->returnValue($metadataExtend));
